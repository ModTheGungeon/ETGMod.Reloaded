...
namespace ETGMod{
    ...
    public partial class Animation {
        ...
        {
            public static Dictionary<string, tk2dSpriteCollectionData> AllCollections = new Dictionary<string, tk2dSpriteCollectionData>();
            ...
            public static DumpData Dump(string collectionName)
            {
                tk2dSpriteCollectionData coll = AllCollections[collectionName];
                return Dump(coll);
            }
